...
X1<-read.table("C:/Users/Aishwarya/Documents/R/UCI HAR Dataset/test/X_test.txt")

X2<-read.table("C:/Users/Aishwarya/Documents/R/UCI HAR Dataset/train/X_train.txt")
data<-rbind(X1,X2)

Y1<-read.table("C:/Users/Aishwarya/Documents/R/UCI HAR Dataset/test/Y_test.txt")

Y2<-read.table("C:/Users/Aishwarya/Documents/R/UCI HAR Dataset/train/Y_train.txt")
y<-rbind(Y1,Y2)

S1<-read.table("C:/Users/Aishwarya/Documents/R/UCI HAR Dataset/test/subject_test.txt")
S2<-read.table("C:/Users/Aishwarya/Documents/R/UCI HAR Dataset/train/subject_train.txt")
subject<-rbind(S1,S2)
Activity_labels<-read.table("C:/Users/Aishwarya/Documents/R/UCI HAR Dataset/activity_labels.txt")
features_list<-read.table("C:/Users/Aishwarya/Documents/R/UCI HAR Dataset/features.txt")
